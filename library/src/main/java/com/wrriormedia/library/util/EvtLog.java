...
import com.wrriormedia.library.http.NetworkException;
...
public class EvtLog {
    ...
    static {
        IS_DEBUG_LOGGABLE = com.wrriormedia.library.util.PackageUtil.getConfigBoolean("debug_log_enable");
        IS_ERROR_LOGGABLE = com.wrriormedia.library.util.PackageUtil.getConfigBoolean("error_log_enable");
    }
    ...
    public static void e(String tag, Throwable exception) {
        String message;
        if (IS_ERROR_LOGGABLE) {
            if (exception instanceof com.wrriormedia.library.util.MessageException) {
