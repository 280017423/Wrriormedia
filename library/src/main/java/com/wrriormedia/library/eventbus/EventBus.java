 ...
 */
package com.wrriormedia.library.eventbus;
...
public class EventBus {
    ...
    private void subscribe(Object subscriber, SubscriberMethod subscriberMethod, boolean sticky, int priority) {
        ...
        if (subscriptions == null) {
            ...
            if (subscriptions.contains(newSubscription)) {
                throw new com.wrriormedia.library.eventbus.EventBusException("Subscriber " + subscriber.getClass() + " already registered to event "
                        + eventType);
            }
        }
    ...
    public void post(Object event) {
        ...
        if (!postingState.isPosting) {
            ...
            if (postingState.canceled) {
                throw new com.wrriormedia.library.eventbus.EventBusException("Internal error. Abort state was not reset");
            }
            try {
    ...
    public void cancelEventDelivery(Object event) {
        PostingThreadState postingState = currentPostingThreadState.get();
        if (!postingState.isPosting) {
            throw new com.wrriormedia.library.eventbus.EventBusException(
                    "This method may only be called from inside event handling methods on the posting thread");
        } else if (event == null) {
            throw new EventBusException("Event may not be null");
        } else if (postingState.event != event) {
            throw new com.wrriormedia.library.eventbus.EventBusException("Only the currently handled event may be aborted");
        } else if (postingState.subscription.subscriberMethod.threadMode != com.wrriormedia.library.eventbus.ThreadMode.PostThread) {
    ...
    private void postSingleEvent(Object event, PostingThreadState postingState) throws Error {
        ...
        if (!subscriptionFound) {
            ...
            if (sendNoSubscriberEvent && eventClass != com.wrriormedia.library.eventbus.NoSubscriberEvent.class &&
