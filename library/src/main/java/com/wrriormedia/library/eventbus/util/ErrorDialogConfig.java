...
public class ErrorDialogConfig {
    ...
    final com.wrriormedia.library.eventbus.util.ExceptionToResourceMapping mapping;
    ...
    public ErrorDialogConfig(Resources resources, int defaultTitleId, int defaultMsgId) {
        ...
        mapping = new com.wrriormedia.library.eventbus.util.ExceptionToResourceMapping();
    }
