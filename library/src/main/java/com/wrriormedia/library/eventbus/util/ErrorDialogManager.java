...
public class ErrorDialogManager {
    ...
    protected static void checkLogException(com.wrriormedia.library.eventbus.util.ThrowableFailureEvent event) {
    ...
    private static boolean isInExecutionScope(Object executionScope, com.wrriormedia.library.eventbus.util.ThrowableFailureEvent event) {
        if (event != null) {
