 ...
 * some different keys are considered as equals (using {@link Comparator
 * comparator}). And when you try to put some value into cache by key so entries
 * with "equals" keys will be removed from cache before.<br />
