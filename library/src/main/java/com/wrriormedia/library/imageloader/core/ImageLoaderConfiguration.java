...
public final class ImageLoaderConfiguration {
    ...
    public static class Builder {
        ...
        private com.wrriormedia.library.imageloader.core.DisplayImageOptions defaultDisplayImageOptions = null;
        ...
        public Builder memoryCacheSize(int memoryCacheSize) {
            ...
            if (memoryCache != null)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_MEMORY_CACHE_ALREADY_SET);
        ...
        public Builder memoryCache(MemoryCacheAware<String, Bitmap> memoryCache) {
            if (memoryCacheSize != DEFAULT_MEMORY_CACHE_SIZE)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_MEMORY_CACHE_SIZE);
        ...
        public Builder discCacheSize(int maxCacheSize) {
            ...
            if (discCache != null)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_DISC_CACHE_ALREADY_SET);
            if (discCacheFileCount > 0)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_DISC_CACHE_FILE_COUNT);
        ...
        public Builder discCacheFileCount(int maxFileCount) {
            ...
            if (discCache != null)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_DISC_CACHE_ALREADY_SET);
            if (discCacheSize > 0)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_DISC_CACHE_SIZE);
        ...
        public Builder discCache(DiscCacheAware discCache) {
            ...
            if (discCacheFileNameGenerator != null)
                Log.w(com.wrriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_DISC_CACHE_FILE_NAME_GENERATOR);
         ...
         * options}
         */
        public Builder defaultDisplayImageOptions(com.wrriormedia.library.imageloader.core.DisplayImageOptions defaultDisplayImageOptions) {
        ...
        private void initEmptyFiledsWithDefaultValues() {
            if (discCache == null) {
                if (discCacheFileNameGenerator == null) {
                    discCacheFileNameGenerator = com.wrriormedia.library.imageloader.core.DefaultConfigurationFactory.createFileNameGenerator();
                }
                discCache = com.wrriormedia.library.imageloader.core.DefaultConfigurationFactory.createDiscCache(context, discCacheFileNameGenerator,
                        discCacheSize, discCacheFileCount);
            }
            if (memoryCache == null) {
                memoryCache = com.wrriormedia.library.imageloader.core.DefaultConfigurationFactory.createMemoryCache(memoryCacheSize,
                        denyCacheImageMultipleSizesInMemory);
            }
            if (downloader == null) {
                downloader = com.wrriormedia.library.imageloader.core.DefaultConfigurationFactory.createImageDownloader();
            }
            if (defaultDisplayImageOptions == null) {
                defaultDisplayImageOptions = com.wrriormedia.library.imageloader.core.DisplayImageOptions.createSimple();
            }
