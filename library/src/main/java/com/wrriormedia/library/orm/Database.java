package com.wrriormedia.library.orm;
...
public class Database {
    ...
    private static Map<String, com.wrriormedia.library.orm.DatabaseBuilder> BUILDERS = new HashMap<>();
     ...
     */
    Database(Context context, String dbName, int dbVersion, com.wrriormedia.library.orm.DatabaseBuilder builder) {
     ...
     */
    public static com.wrriormedia.library.orm.DatabaseBuilder getBuilder(String dbName) {
     ...
     * @return
     */
    public static void setBuilder(com.wrriormedia.library.orm.DatabaseBuilder builder) {
     ...
     * @return 创建好的数据库对象
     */
    public static Database createInstance(Context ctx, String dbName, int dbVersion, com.wrriormedia.library.orm.DatabaseBuilder builder) {
    ...
    public Cursor query(boolean distinct, String table, String[] selectColumns, String where, String[] whereArgs,
        ...
        if (null == mSQLiteDatabase || !mSQLiteDatabase.isOpen()) {
            ...
            throw new DataAccessException(com.wrriormedia.library.orm.Utils.ERR_DB_IS_NOT_OPEN);
        }
