...
public abstract class BaseActionProcessor {
    ...
    public abstract void startAction(Activity activity, boolean isOnUiThreadCallBack, boolean returnToMain,
                                     final com.wrriormedia.library.authentication.IBaseActionListener listener);
     ...
     * @param listener 回调对象
     */
    public void startAction(Activity activity, final com.wrriormedia.library.authentication.IBaseActionListener listener) {
     ...
     * @param listener     回调对象
     */
    public void startAction(Activity activity, boolean returnToMain, com.wrriormedia.library.authentication.IBaseActionListener listener) {
     ...
     * @param listener 回调对象
     */
    public void startActionOnUiCallBack(Activity activity, final com.wrriormedia.library.authentication.IBaseActionListener listener) {
