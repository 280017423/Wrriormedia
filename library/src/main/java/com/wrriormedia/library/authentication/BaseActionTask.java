 ...
 */
public abstract class BaseActionTask<T extends com.wrriormedia.library.authentication.BaseActionResult> {
    ...
    public class BaseTask extends AsyncTask<Void, Void, T> {
        ...
        protected T doInBackground(Void... params) {
            ...
            if (mIsCancelLogin) {
                ...
                // 网络请求
                com.wrriormedia.library.authentication.IBaseActionListener<T> mListener = mAction.getListener();
                if (mListener == null) {
                    return null;
                }
