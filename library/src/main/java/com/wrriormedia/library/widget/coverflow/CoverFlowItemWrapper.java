...
class CoverFlowItemWrapper extends ViewGroup {
    ...
    public CoverFlowItemWrapper(Context context, AttributeSet attrs) {
        super(context, attrs);
        this.init();
    }

    public CoverFlowItemWrapper(Context context, AttributeSet attrs, int defStyle) {
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        if (this.isReflectionEnabled) {
            this.setMeasuredDimension((int) (this.getMeasuredWidth() * this.originalScaledownFactor),
    ...
    private void createReflectedImages() {
        ...
        final Bitmap invertedBitmap = Bitmap.createBitmap(this.wrappedViewBitmap, 0, invertedBitmapSourceTop, width,
        ...
        final LinearGradient shader = new LinearGradient(
                0, height * imageReflectionRatio + reflectionGap, 0, height, 0x70ffffff, 0x00ffffff,
