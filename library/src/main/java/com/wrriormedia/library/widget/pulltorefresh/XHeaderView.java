...
public class XHeaderView extends LinearLayout {
    ...
    private ImageView mIvHeaderDivider;
    ...
    private void initView(Context context) {
        ...
        mContainer = (LinearLayout) View.inflate(context, R.layout.vw_header, null);
        addView(mContainer, lp);
        setGravity(Gravity.BOTTOM);

        mIvHeaderDivider = (ImageView) findViewById(R.id.iv_header_divider);
    ...
    public void setHeaderDivider(int color) {
        mIvHeaderDivider.setBackgroundColor(color);
    }
