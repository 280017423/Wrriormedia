...
public class XScrollView extends ScrollView implements OnScrollListener {
    ...
    private boolean mEnableAutoRefresh; // 自动显示头部
    ...
    private void initWithContext(Context context) {
        ...
        mHeaderTime = (TextView) mHeader.findViewById(R.id.pull_to_refresh_sub_text);
        LinearLayout headerLayout = (LinearLayout) mLayout.findViewById(R.id.header_layout);
        headerLayout.addView(mHeader);
        setRefreshTime(buildRefreshingSubheaderText());
        // init footer view
    ...
    private String buildRefreshingSubheaderText() {
        ...
        return PackageUtil.getString(R.string.pull_to_refresh_header_subtext_label) + dateString;
    }
    ...
    public void setHeaderDivider(int color) {
        mHeader.setHeaderDivider(color);
    }

    public void setNoMoreData(boolean hasMoreData) {
        mHasMoreData = hasMoreData;
        mFooterView.setNoMoreData(hasMoreData);
    }
