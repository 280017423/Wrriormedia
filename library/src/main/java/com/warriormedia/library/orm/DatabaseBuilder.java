...
public class DatabaseBuilder {
    ...
    public String[] getTables() {
        ...
        for (int i = 0; i < arr.length; i++) {
            Class c = arr[i];
            ret[i] = com.warriormedia.library.orm.Utils.toSQLName(c.getSimpleName());
        }
        return ret;
    }
    ...
    public <T extends BaseModel> String getSQLCreate(String table)
        ...
        if (null != c) {
            ...
            for (Field column : e.getColumnFieldsWithoutID()) {
                ...
                String qname = com.warriormedia.library.orm.Utils.toSQLName(jname);
                Class<?> columntype = column.getType();
                String sqliteType = com.warriormedia.library.orm.Utils.getSQLiteTypeString(columntype);
    ...
    private Class getClassBySqlName(String table) {
        String jName = com.warriormedia.library.orm.Utils.toJavaClassName(table);
