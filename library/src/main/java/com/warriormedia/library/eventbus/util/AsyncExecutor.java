        ...
        threadPool.execute(new Runnable() {
            ...
            public void run() {
                try {
                    ...
                    if (event instanceof com.warriormedia.library.eventbus.util.HasExecutionScope) {
                        ((com.warriormedia.library.eventbus.util.HasExecutionScope) event).setExecutionScope(scope);
                    }
                    eventBus.post(event);
                }
            }
    ...
    public static class Builder {
        ...
        public AsyncExecutor buildForScope(Object executionContext) {
            ...
            if (failureEventType == null) {
                failureEventType = com.warriormedia.library.eventbus.util.ThrowableFailureEvent.class;
            }
