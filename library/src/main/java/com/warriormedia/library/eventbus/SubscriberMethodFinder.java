                ...
                if (methodName.startsWith(ON_EVENT_METHOD_NAME)) {
                    ...
                    if ((modifiers & Modifier.PUBLIC) != 0 && (modifiers & MODIFIERS_IGNORE) == 0) {
                        ...
                        if (parameterTypes.length == 1) {
                            ...
                            com.warriormedia.library.eventbus.ThreadMode threadMode;
                            if (modifierString.length() == 0) {
                                threadMode = com.warriormedia.library.eventbus.ThreadMode.PostThread;
                            } else if (modifierString.equals("MainThread")) {
                                threadMode = com.warriormedia.library.eventbus.ThreadMode.MainThread;
                            } else if (modifierString.equals("BackgroundThread")) {
                                threadMode = com.warriormedia.library.eventbus.ThreadMode.BackgroundThread;
                            } else if (modifierString.equals("Async")) {
                                threadMode = com.warriormedia.library.eventbus.ThreadMode.Async;
                            } else {
