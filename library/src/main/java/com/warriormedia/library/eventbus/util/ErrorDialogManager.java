...
public class ErrorDialogManager {
    ...
    protected static void checkLogException(com.warriormedia.library.eventbus.util.ThrowableFailureEvent event) {
    ...
    private static boolean isInExecutionScope(Object executionScope, com.warriormedia.library.eventbus.util.ThrowableFailureEvent event) {
        if (event != null) {
    ...
    public static class SupportManagerFragment extends Fragment {
        ...
        public void onEventMainThread(com.warriormedia.library.eventbus.util.ThrowableFailureEvent event) {
