...
public class ErrorDialogFragments {
    ...
    public static Dialog createDialog(Context context, Bundle arguments, OnClickListener onClickListener) {
        ...
        builder.setTitle(arguments.getString(com.warriormedia.library.eventbus.util.ErrorDialogManager.KEY_TITLE));
        builder.setMessage(arguments.getString(com.warriormedia.library.eventbus.util.ErrorDialogManager.KEY_MESSAGE));
    ...
    public static void handleOnClick(DialogInterface dialog, int which, Activity activity, Bundle arguments) {
        if (EVENT_TYPE_ON_CLICK != null) {
            ...
            EventBus eventBus = com.warriormedia.library.eventbus.util.ErrorDialogManager.factory.config.getEventBus();
            eventBus.post(event);
        }
        boolean finish = arguments.getBoolean(com.warriormedia.library.eventbus.util.ErrorDialogManager.KEY_FINISH_AFTER_DIALOG, false);
