...
public class ErrorDialogConfig {
    ...
    final com.warriormedia.library.eventbus.util.ExceptionToResourceMapping mapping;
    ...
    public ErrorDialogConfig(Resources resources, int defaultTitleId, int defaultMsgId) {
        ...
        mapping = new com.warriormedia.library.eventbus.util.ExceptionToResourceMapping();
    }
