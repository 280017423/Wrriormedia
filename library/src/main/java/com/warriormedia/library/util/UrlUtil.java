...
public class UrlUtil {
    ...
    public static String buildContent(List<NameValuePair> getParams) {
        ...
        for (int i = 0; i < getParams.size(); i++) {
            ...
            if (nameValuePair != null) {
                String key = com.warriormedia.library.util.StringUtil.isNullOrEmpty(nameValuePair.getName()) ? "" : nameValuePair.getName();
                String value = com.warriormedia.library.util.StringUtil.isNullOrEmpty(nameValuePair.getValue()) ? "" : nameValuePair.getValue();
    ...
    public static String getSignString(List<NameValuePair> getParams) {
        ...
        com.warriormedia.library.util.EvtLog.d(TAG, "content:  " + content);
        if (com.warriormedia.library.util.StringUtil.isNullOrEmpty(content)) {
            return "";
        }
        String sign = com.warriormedia.library.util.StringUtil.getMd5Hash(content, null);
        if (com.warriormedia.library.util.StringUtil.isNullOrEmpty(sign)) {
            return "";
        }
