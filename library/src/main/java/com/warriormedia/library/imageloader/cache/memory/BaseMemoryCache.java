package com.warriormedia.library.imageloader.cache.memory;
 ...
 * object references ( {@linkplain Reference not strong}) storing.
 *
 * @author Sergey Tarasevich (nostra13[at]gmail[dot]com)
 */
public abstract class BaseMemoryCache<K, V> implements com.warriormedia.library.imageloader.cache.memory.MemoryCacheAware<K, V> {
