...
import com.warriormedia.library.imageloader.cache.disc.impl.UnlimitedDiscCache;
...
import com.warriormedia.library.imageloader.core.download.ImageDownloader;
...
public final class ImageLoaderConfiguration {
     ...
     * <li>memoryCache = {@link UsingFreqLimitedCache} with limited memory cache
     * size ( {@link Builder#DEFAULT_MEMORY_CACHE_SIZE this} bytes)</li>
     ...
     * {@link FileNameGenerator#createDefault()}</li>
    ...
    public static class Builder {
        ...
        private com.warriormedia.library.imageloader.core.DisplayImageOptions defaultDisplayImageOptions = null;
         ...
         *
         * @param maxImageWidthForMemoryCache  Maximum image width which will be used for memory saving
         *                                     during decoding an image to
         *                                     {@link android.graphics.Bitmap Bitmap}. <b>Default value -
         *                                     device's screen width</b>
         * @param maxImageHeightForMemoryCache Maximum image height which will be used for memory saving
         *                                     during decoding an image to
         ...
         *
         * @param maxImageWidthForDiscCache  Maximum width of downloaded images for saving at disc
         *                                   cache
         * @param maxImageHeightForDiscCache Maximum height of downloaded images for saving at disc
         *                                   cache
         * @param compressFormat             {@link android.graphics.Bitmap.CompressFormat Compress
        ...
        /**
         * Sets the priority for image loading threads. Must be <b>NOT</b>
        ...
        /**
         * ImageLoader try clean memory and re-display image it self when
         * {@link OutOfMemoryError} occurs. You can switch off this feature by
         * this method and process error by your way (you can know that
         * {@link OutOfMemoryError} occurred if you got
         * {@link FailReason#OUT_OF_MEMORY} in
         ...
         * {@link com.nostra13.universalimageloader.cache.memory.impl.UsingFreqLimitedMemoryCache
         * UsingFreqLimitedCache} will be used as memory cache. You can use
         * {@link #memoryCache(MemoryCacheAware)} method for introduction your
        ...
        public Builder memoryCacheSize(int memoryCacheSize) {
            ...
            if (memoryCache != null)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_MEMORY_CACHE_ALREADY_SET);
         ...
         * {@link #DEFAULT_MEMORY_CACHE_SIZE this})<br />
         * <b>NOTE:</b> You can use {@link #memoryCacheSize(int)} method instead
         * of this method to simplify memory cache tuning.
         */
        public Builder memoryCache(MemoryCacheAware<String, Bitmap> memoryCache) {
            if (memoryCacheSize != DEFAULT_MEMORY_CACHE_SIZE)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_MEMORY_CACHE_SIZE);
        ...
        public Builder discCacheSize(int maxCacheSize) {
            ...
            if (discCache != null)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_DISC_CACHE_ALREADY_SET);
            if (discCacheFileCount > 0)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_DISC_CACHE_FILE_COUNT);
        ...
        public Builder discCacheFileCount(int maxFileCount) {
            ...
            if (discCache != null)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_DISC_CACHE_ALREADY_SET);
            if (discCacheSize > 0)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_DISC_CACHE_SIZE);
        ...
        public Builder discCache(DiscCacheAware discCache) {
            ...
            if (discCacheFileNameGenerator != null)
                Log.w(com.warriormedia.library.imageloader.core.ImageLoader.TAG, WARNING_OVERLAP_DISC_CACHE_FILE_NAME_GENERATOR);
         ...
         * options}
         */
        public Builder defaultDisplayImageOptions(com.warriormedia.library.imageloader.core.DisplayImageOptions defaultDisplayImageOptions) {
        ...
        private void initEmptyFiledsWithDefaultValues() {
            if (discCache == null) {
                if (discCacheFileNameGenerator == null) {
                    discCacheFileNameGenerator = com.warriormedia.library.imageloader.core.DefaultConfigurationFactory.createFileNameGenerator();
                }
                discCache = com.warriormedia.library.imageloader.core.DefaultConfigurationFactory.createDiscCache(context, discCacheFileNameGenerator,
                        discCacheSize, discCacheFileCount);
            }
            if (memoryCache == null) {
                memoryCache = com.warriormedia.library.imageloader.core.DefaultConfigurationFactory.createMemoryCache(memoryCacheSize,
                        denyCacheImageMultipleSizesInMemory);
            }
            if (downloader == null) {
                downloader = com.warriormedia.library.imageloader.core.DefaultConfigurationFactory.createImageDownloader();
            }
            if (defaultDisplayImageOptions == null) {
                defaultDisplayImageOptions = com.warriormedia.library.imageloader.core.DisplayImageOptions.createSimple();
            }
