...
public class MyVideoView extends SurfaceView implements MediaPlayerControl {
	...
	/**
	 * setMeasuredDimension: current view size
	 */
	@Override
	...
	SurfaceHolder.Callback mSHCallback = new SurfaceHolder.Callback() {
		public void surfaceChanged(SurfaceHolder holder, int format,
				int w, int h) {
			if (DEBUG) {
				Log.d(TAG, "surfaceChanged, surfaceChanged, surfaceChanged");
			}
			mSurfaceWidth = w;
			mSurfaceHeight = h;
		...
		public void surfaceCreated(SurfaceHolder holder) {
			if (DEBUG) {
				Log.d(TAG, "surfaceCreated, surfaceCreated, surfaceCreated, surfaceCreated");
			}
		...
		public void surfaceDestroyed(SurfaceHolder holder) {
			if (DEBUG) {
				Log.e(TAG, "surfaceDestroyed, surfaceDestroyed, surfaceDestroyed");
			}
			mSurfaceHolder = null;
			if (mMediaController != null) {
				mMediaController.hide();
